        ...
        <>
            <div className="flex gap-2 mt-1 mb-2">
                <input
                    ...
                    className="w-full bg-white/10 focus:ring-indigo-500 focus:border-indigo-500 rounded-md shadow-sm sm:text-sm border-gray-300/10"
                    placeholder="Напишете думата която искате да римувате..."
                />
                <button className="inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white/90 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500" onClick={function (e) {
                    searchForRhymes();
                }}>
